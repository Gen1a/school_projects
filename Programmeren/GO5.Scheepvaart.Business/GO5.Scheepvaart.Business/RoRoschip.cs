...
namespace GO5.Scheepvaart.Business
{
    public class RoRoschip : Vrachtschip // Roll-on-roll-offschip
    {
        ...
        {
            if (aantalAutos < 0) throw new ArgumentOutOfRangeException("Aantal auto's moet groter zijn dan of gelijk aan 0.");
            if (aantalTrucks < 0) throw new ArgumentOutOfRangeException("Aantal trucks moet groter zijn dan of gelijk aan 0.");
